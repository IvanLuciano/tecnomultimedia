void ComidaPescar() {
  if (contador == 421) {
    ...
    textSize(35);
    fill(255, 0, 255);
    image(pescar, width/2, height/2, 800, 600);
  ...
  if (contador == 6223) {
    ...
    textSize(35);
    fill(255, 0, 255);
    image(dormir, width/2, height/2, 800, 600); // cambiar imagen (dia, no madera, descansar en carpa)
  ...
  if (contador == 6233) {
    ...
    textSize(35);
    fill(255, 0, 255);
    image(noche, width/2, height/2, 800, 600); // cambiar imagen (fogata apagada noche)
