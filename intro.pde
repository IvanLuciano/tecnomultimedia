void Inicio() {
  if (contador == 0) { // PRESENTACIO
    ...
    if (mouseX > width/2.66 && mouseY > height/2 && mouseX < width/1.6 && mouseY < height/1.714) { //BOTON
      contador= 1;
    }
  }
  if (contador == 0) {
    ...
    if (mouseX >= width*0.8625 && mouseY >= height*0.1125 && mouseX <= width && mouseY <= height*0.216) { //BOTON
      contador= 11000;
    }
  }
